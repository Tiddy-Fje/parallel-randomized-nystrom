...
%%%
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{exp_decay_stability.png}
	...
	% ARE WE SURE THIS IS NOT JUST BECAUSE L IS TOO SMALL ?
	% SHOULD WE MABE TAKE A RANK (BEFORE DECAY) THAT IS SMALLER THAN L ?  -> BECAUSE OTHERWISE EMBEDDING TASK IS TOO HARD, NO ?
	% I DON'T UNDERSTAND THE FOLLOWING : THE GAUSSIAN ERRORS SEEM EXTREMELY SMOOTH TO ME, AREN'T THEY ?
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{MNIST_stability.png}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{poly_decay_stability.png}
