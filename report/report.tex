...
\subsection{Performance Analysis}
        ...
        \subsection{Parallel Performance}
			...
			\begin{figure}[htbp]       
				\centering             
					\vspace{0em}
					\includegraphics[width=.8\textwidth]{runtimes_cores_variation}
...
\section{Conclusion}
\vspace{-0.5em} % Adjust vertical spacing if needed to fit the content
\enlargethispage{\baselineskip} % Force the page to accommodate more lines
